...
//   gl.bindTexture(gl.TEXTURE_2D, i.targetTexture);
...
//                   i.targetTextureWidth, i.targetTextureHeight, border,
//                   format, type, data);
...
//   const level = 0;
//   gl.framebufferTexture2D(gl.FRAMEBUFFER, attachmentPoint, gl.TEXTURE_2D, i.targetTexture, level);
...
// for (var ii = 0; ii < i.numObjects; ++ii) {
//     i.objects.push({
//         radius: rand(150),
